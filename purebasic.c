...
integer r13=PB_SortList_THREAD(p16,0LL);
// 
...
static integer f_initrewriteengine() {
integer r=0;
// ReDim g_GR_RuleType(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_ruletype);
// ReDim g_GR_MatchType(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_matchtype);
// ReDim g_GR_Pattern(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_pattern);
// ReDim g_GR_Destination(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_destination);
// ReDim g_GR_Code(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_code);
// ReDim g_GR_RegexHandle(#MAX_GLOBAL_RULES)
SYS_ReAllocateArray(64,&a_g_gr_regexhandle);
// ReDim g_DC_DirPath(#MAX_DIR_CACHE)
SYS_ReAllocateArray(8,&a_g_dc_dirpath);
// ReDim g_DC_FileMtime(#MAX_DIR_CACHE)
SYS_ReAllocateArray(8,&a_g_dc_filemtime);
// ReDim g_DC_RuleCount(#MAX_DIR_CACHE)
SYS_ReAllocateArray(8,&a_g_dc_rulecount);
// ReDim g_DR_RuleType(127)
SYS_ReAllocateArray(128,&a_g_dr_ruletype);
// ReDim g_DR_MatchType(127)
SYS_ReAllocateArray(128,&a_g_dr_matchtype);
// ReDim g_DR_Pattern(127)
SYS_ReAllocateArray(128,&a_g_dr_pattern);
// ReDim g_DR_Destination(127)
SYS_ReAllocateArray(128,&a_g_dr_destination);
// ReDim g_DR_Code(127)
SYS_ReAllocateArray(128,&a_g_dr_code);
// ReDim g_DR_RegexHandle(127)
SYS_ReAllocateArray(128,&a_g_dr_regexhandle);
// g_GR_Count = 0
g_g_gr_count=0;
// g_DC_Count = 0
g_g_dc_count=0;
...
integer r6=PB_SortList_THREAD(p12,2LL);
// SortList(files(), #PB_Sort_Ascending | #PB_Sort_NoCase)
void* p13=(void*)(t_files.a);
integer r7=PB_SortList_THREAD(p13,2LL);
// 
// 
